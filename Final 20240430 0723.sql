...
INSERT INTO `company` (`companyid`,`companyname`,`address`,`phone`,`email`) VALUES 
 ...
 ('CP-0000003','Yangon Development','Zalon Street','095184102','ygn@gmail.com'),
 ('CP-0000004','update test','update address','0923452123','asdfs@gmail.com'),
 ('CP-0000005','focus test','focus address','091267612','focus@gmail.com');
...
INSERT INTO `customerservicedetail` (`customerid`,`serviceid`,`date`,`status`,`solution`) VALUES 
 ('Cu-0000001','SV-0000001','2024-04-29','Received by Customer','Hello this is test solution'),
 ('CU-0000003','SV-0000002','2024-04-25','Received by Customer','This is only test for solution, you can add anything you want from here'),
 ('CU-0000002','SV-0000003','2024-04-19','-',''),
 ('Cu-0000001','SV-0000004','2024-04-19','-',''),
 ('CU-0000001','SV-0000005','2024-04-29','Incomplete','what the hell is going on');
...
INSERT INTO `item` (`itemid`,`brandid`,`typeid`,`itemname`,`currentprice`,`warranty`,`remark`,`serial`) VALUES 
 (96,'BR-0000001','Ty-0000001','Nay Kyar Si',10,'2 years','-','This is test serial'),
 (97,'BR-0000001','Ty-0000001','Nay Kyar Si',10,'2 years','-','CT97124'),
 (98,'BR-0000001','Ty-0000001','Nay Kyar Si',10,'2 years','-','-'),
 (99,'BR-0000001','Ty-0000001','Nay Kyar Si',10,'2 years','-','-'),
 (100,'BR-0000001','Ty-0000001','Nay Kyar Si',10,'2 years','-','SD001781'),
 (101,'BR-0000001','TY-0000002','Fujitsu Laptop',100,'','-','PC0612'),
 (102,'BR-0000001','TY-0000002','LIfeBook E459',100,'2 Years','-','R9Y000'),
 (103,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (104,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (105,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (106,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (107,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (108,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-');
INSERT INTO `item` (`itemid`,`brandid`,`typeid`,`itemname`,`currentprice`,`warranty`,`remark`,`serial`) VALUES 
 (109,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (110,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'1 year','RK61 batch buy','-'),
 (112,'BR-0000001','Ty-0000001','RK61 Keyboard',20,'2 year','RK61 batch buy','Clear serial test'),
 (113,'BR-0000001','Ty-0000001','RK61 Keyboard',200,'1 year','RK61 batch buy','Test Serial for 61'),
 (114,'BR-0000004','TY-0000005','GTX 4060TI',1000000,'3 years','-','GT789123'),
 (115,'BR-0000002','Ty-0000001','add',123,'6 months','-','-'),
 (116,'BR-0000005','Ty-0000001','Ethernet Cable',10000,'-','-','-'),
 (117,'BR-0000005','Ty-0000001','Ethernet Cable',10000,'-','-','-'),
 (118,'BR-0000005','Ty-0000001','Ethernet Cable',10000,'-','-','-'),
 (119,'BR-0000005','Ty-0000001','Ethernet Cable',10000,'-','-','-'),
 (120,'BR-0000005','Ty-0000001','Ethernet Cable',10000,'-','-','-'),
 (121,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (122,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-');
INSERT INTO `item` (`itemid`,`brandid`,`typeid`,`itemname`,`currentprice`,`warranty`,`remark`,`serial`) VALUES 
 (123,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (124,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (125,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (126,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (127,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (128,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (129,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (130,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (131,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (132,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (133,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (134,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (135,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-');
INSERT INTO `item` (`itemid`,`brandid`,`typeid`,`itemname`,`currentprice`,`warranty`,`remark`,`serial`) VALUES 
 (136,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (137,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (138,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (139,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-'),
 (140,'BR-0000002','TY-0000006','Philips 27M8',300000,'3 Years','-','-');
...
INSERT INTO `payment` (`paymentid`,`saleorderid`,`staffid`,`amount`,`paymenttype`,`remark`,`date`) VALUES 
 ('PA-0000001','SA-0000017','ST-0000003',800,'Installment','','2024-04-30'),
 ('PA-0000002','SA-0000017','ST-0000003',300,'Installment','2nd payment','2024-04-30'),
 ('PA-0000003','SA-0000017','ST-0000003',400,'Installment','','2024-04-30'),
 ('PA-0000004','SA-0000012','ST-0000006',230,'Full Payment','','2024-04-30'),
 ('PA-0000006','SA-0000018','ST-0000003',44,'Installment','First Payment','2024-04-30');
...
INSERT INTO `purchase` (`purchaseid`,`companyid`,`purchasedate`) VALUES 
 ...
 ('PR-0000004','CP-0000002','2024-04-25'),
 ('PR-0000005','CP-0000002','2024-04-25'),
 ('PR-0000006','CP-0000005','2024-04-30'),
 ('PR-0000007','CP-0000005','2024-04-30'),
 ('PR-0000008','CP-0000003','2024-04-30');
...
INSERT INTO `purchasedetail` (`purchaseid`,`itemname`,`purchaseprice`,`purchaseqty`,`itemid`) VALUES 
 ...
 ('PR-0000004','Fujitsu Laptop',100,1,101),
 ('PR-0000005','LIfeBook E459',100,1,102),
 ('PR-0000005','RK61 Keyboard',20,12,103),
 ('PR-0000005','RK61 Keyboard',20,12,104),
 ('PR-0000005','RK61 Keyboard',20,12,105),
 ('PR-0000005','RK61 Keyboard',20,12,106),
 ('PR-0000005','RK61 Keyboard',20,12,107),
 ('PR-0000005','RK61 Keyboard',20,12,108),
 ('PR-0000005','RK61 Keyboard',20,12,109),
 ('PR-0000005','RK61 Keyboard',20,12,110);
INSERT INTO `purchasedetail` (`purchaseid`,`itemname`,`purchaseprice`,`purchaseqty`,`itemid`) VALUES 
 ('PR-0000005','RK61 Keyboard',20,12,112),
 ('PR-0000005','RK61 Keyboard',20,12,113),
 ('PR-0000006','GTX 4060TI',1000000,1,114),
 ('PR-0000007','add',123,1,115),
 ('PR-0000007','Ethernet Cable',10000,5,116),
 ('PR-0000007','Ethernet Cable',10000,5,117),
 ('PR-0000007','Ethernet Cable',10000,5,118),
 ('PR-0000007','Ethernet Cable',10000,5,119),
 ('PR-0000007','Ethernet Cable',10000,5,120),
 ('PR-0000008','Philips 27M8',300000,20,121),
 ('PR-0000008','Philips 27M8',300000,20,122),
 ('PR-0000008','Philips 27M8',300000,20,123),
 ('PR-0000008','Philips 27M8',300000,20,124),
 ('PR-0000008','Philips 27M8',300000,20,125),
 ('PR-0000008','Philips 27M8',300000,20,126),
 ('PR-0000008','Philips 27M8',300000,20,127),
 ('PR-0000008','Philips 27M8',300000,20,128),
 ('PR-0000008','Philips 27M8',300000,20,129),
 ('PR-0000008','Philips 27M8',300000,20,130),
 ('PR-0000008','Philips 27M8',300000,20,131),
 ('PR-0000008','Philips 27M8',300000,20,132);
INSERT INTO `purchasedetail` (`purchaseid`,`itemname`,`purchaseprice`,`purchaseqty`,`itemid`) VALUES 
 ('PR-0000008','Philips 27M8',300000,20,133),
 ('PR-0000008','Philips 27M8',300000,20,134),
 ('PR-0000008','Philips 27M8',300000,20,135),
 ('PR-0000008','Philips 27M8',300000,20,136),
 ('PR-0000008','Philips 27M8',300000,20,137),
 ('PR-0000008','Philips 27M8',300000,20,138),
 ('PR-0000008','Philips 27M8',300000,20,139),
 ('PR-0000008','Philips 27M8',300000,20,140);
...
INSERT INTO `saleorder` (`saleorderid`,`staffid`,`type`,`date`,`amount`) VALUES 
 ...
 ('SA-0000006','ST-0000005','Full Payment','2024-04-25',130),
 ('SA-0000007','ST-0000001','Full Payment','2024-04-30',20),
 ('SA-0000009','ST-0000005','Full Payment','2024-04-30',1100),
 ('SA-0000011','ST-0000001','Full Payment','2024-04-30',130),
 ('SA-0000012','ST-0000001','Full Payment','2024-04-30',230),
 ('SA-0000017','ST-0000001','Installment','2024-04-30',1500),
 ('SA-0000018','ST-0000001','Installment','2024-04-30',110);
...
INSERT INTO `saleorderdetail` (`saleorderid`,`itemid`,`customerid`,`serial`,`price`) VALUES 
 ('SA-0000011',92,'CU-0000002','-',10),
 ('SA-0000011',101,'CU-0000002','PC0612',100),
 ('SA-0000011',105,'CU-0000002','-',20),
 ('SA-0000012',98,'Cu-0000001','-',10),
 ('SA-0000012',106,'Cu-0000001','-',20),
 ('SA-0000012',113,'Cu-0000001','Test Serial for 61',200),
 ('SA-0000017',88,'Cu-0000001','M2A9897141',1000),
 ('SA-0000017',89,'Cu-0000001','GT19981111',500),
 ('SA-0000018',102,'CU-0000002','R9Y000',100);
...
INSERT INTO `staff` (`staffid`,`staffname`,`postid`,`deptid`,`email`,`phone`,`address`) VALUES 
 ...
 ('ST-0000002','Test Security Officer','P-00000012','DP-0000003','redgay@gmal.com','0912673697','asdfasdfasdf'),
 ('ST-0000003','Test Manager Dude','P-00000014','DP-0000004','asdf@gmail.com','0912341451','asdfasdfasdf'),
 ...
 ('ST-0000006','Update','P-00000014','DP-0000003','asdf@gmail.com','09978126736','Update Address');
